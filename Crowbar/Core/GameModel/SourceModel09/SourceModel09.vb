...
#Region "Methods"
	...
	Public Overrides Function WriteTextureFiles(ByVal modelOutputPath As String) As AppEnums.StatusMessage
		...
		ElseIf Me.theTextureMdlFileData09 IsNot Nothing Then
			aTextureList = Me.theTextureMdlFileData09.theTextures
		Else
	...
	Public Overloads Function WriteBoneAnimationSmdFile(ByVal smdPathFileName As String, ByVal aSequence As SourceMdlSequenceDesc09, ByVal blendIndex As Integer) As AppEnums.StatusMessage
		...
		Try
			...
			Dim smdFile As New SourceSmdFile09(Me.theOutputFileTextWriter, Me.theMdlFileData)
	...
	'		Dim aTexture As SourceMdlTexture09
...
#Region "Private Methods"
	...
	Protected Overrides Sub ReadMdlFileHeader_Internal()
		If Me.theMdlFileData Is Nothing Then
			Me.theMdlFileData = New SourceMdlFileData09()
			Me.theMdlFileDataGeneric = Me.theMdlFileData
		End If

		Dim mdlFile As New SourceMdlFile09(Me.theInputFileReader, Me.theMdlFileData)
	...
	Protected Overrides Sub WriteQcFile()
		...
		Dim qcFile As New SourceQcFile09(Me.theOutputFileTextWriter, Me.theQcPathFileName, Me.theMdlFileData, Me.theName)
	...
	Protected Overrides Sub WriteMdlFileNameToMdlFile(ByVal internalMdlFileName As String)
		Dim mdlFile As New SourceMdlFile09(Me.theOutputFileBinaryWriter, Me.theMdlFileData)
...
#Region "Data"
	...
	Private theMdlFileData As SourceMdlFileData09
	'Private theSequenceGroupMdlFileDatas10 As List(Of SourceMdlFileData10)
	Private theTextureMdlFileData09 As SourceMdlFileData09
