...
#Region "Creation and Destruction"
	...
	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData09, ByVal modelName As String)
